...
<table border=0>
<tr><th><f2> GIVE ASSIGNMENT </f2></th></tr>
  ...
  if($_FILES['upfile1']['error']==0)
    {
        ...
        $tpath=$_SERVER['DOCUMENT_ROOT']."project1/upload/1st/".$_FILES['upfile1']['name']; 
  ...
  if($_FILES['upfile2']['error']==0)
    {
        ...
        $tpath=$_SERVER['DOCUMENT_ROOT']."project1/upload/2nd/".$_FILES['upfile2']['name']; 
  ...
  if($_FILES['upfile3']['error']==0)
    {
        ...
        $tpath=$_SERVER['DOCUMENT_ROOT']."project1/upload/3rd/".$_FILES['upfile3']['name']; 
  ...
  if($_FILES['upfile4']['error']==0)
    {
        ...
        $tpath=$_SERVER['DOCUMENT_ROOT']."project1/upload/4th/".$_FILES['upfile4']['name']; 
  ...
  if($_FILES['upfile5']['error']==0)
    {
        ...
        $tpath=$_SERVER['DOCUMENT_ROOT']."project1/upload/5th/".$_FILES['upfile5']['name']; 
  ...
  if($_FILES['upfile6']['error']==0)
    {
        ...
        $tpath=$_SERVER['DOCUMENT_ROOT']."project1/upload/6th/".$_FILES['upfile6']['name']; 
  ...
  if($_FILES['upfile7']['error']==0)
    {
        ...
        $tpath=$_SERVER['DOCUMENT_ROOT']."project1/upload/7th/".$_FILES['upfile7']['name']; 
  ...
  if($_FILES['upfile8']['error']==0)
    {
        ...
        $tpath=$_SERVER['DOCUMENT_ROOT']."project1/upload/8th/".$_FILES['upfile8']['name']; 
